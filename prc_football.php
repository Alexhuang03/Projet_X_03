...
<div id="wapper">
    ...
    <section id="Football" style="text-align: center;">
        <h2 style="text-align: center;">Football</h2>
        <p style="text-align: center;"><strong> Rejoignez nos équipes de football et vivez l'excitation des matchs de compétition !</strong></p>
        <p style="text-align: center;">Le football est bien plus qu'un sport; c'est une passion qui rassemble des millions de personnes à travers le monde. Chez Sportify, nous offrons à nos membres la possibilité de participer à des compétitions de football excitantes et de vivre des moments inoubliables sur le terrain. Participez &agrave; nos tournois de football et am&eacute;liorez vos techniques de jeu.</p>
        <br>
        ...
        <br>
        <h3 style="text-align: center;">Pourquoi choisir le football de compétition avec Sportify ?</h3>
        ...
        <br>
            <h3 style="text-align: center;">D&eacute;couvrez notre coach sp&eacute;cialis&eacute; en Football : </h3>
        <br>
