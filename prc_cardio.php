...
<div id="wapper">
    ...
    <section id="Cardio-Training" style="text-align: center;">
        <h2 style="text-align: center;">Cardio Training</h2>
        <p style="text-align: center;">Am&eacute;liorez votre condition physique avec nos exercices de cardio training. Le cardio training est essentiel pour maintenir une bonne sant&eacute; cardiovasculaire et am&eacute;liorer votre endurance. Que vous soyez un athl&egrave;te chevronn&eacute; ou que vous d&eacute;butiez votre parcours de remise en forme, nos programmes de cardio training sont con&ccedil;us pour vous aider &agrave; atteindre vos objectifs de mani&egrave;re efficace et motivante.</p>
        <br>
        <img src="img/cardiotraining2.jpeg" alt="Cardio" style="width:100%; max-width:600px; display:block; margin: 20px auto;">
        <br>
        <h3 style="text-align: center;">Pourquoi Choisir le Cardio Training ?</h3>
        ...
        <br>
        <img src="img/cardio3.jpg" alt="Cardio" style="width:100%; max-width:600px; display:block; margin: 20px auto;">
        <br>
        <h3 style="text-align: center;">D&eacute;couvrez notre coach sp&eacute;cialis&eacute; en Cardio: </h3>
        <br>
