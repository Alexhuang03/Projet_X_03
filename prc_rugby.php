...
<div id="wapper">
    ...
    <section id="Rugby" style="text-align: center;">
        <h2 style="text-align: center;">Rugby</h2>
        <p style="text-align: center;"><strong>Rejoignez nos équipes de rugby et ressentez l'adrénaline des matchs de compétition !</strong></p>
        <p style="text-align: center;">Le rugby est bien plus qu'un simple sport, c'est une véritable école de vie où se mêlent intensité, stratégie et esprit d'équipe. Chez Sportify, nous offrons à nos membres l'opportunité de participer à des compétitions de rugby passionnantes et de vivre des moments mémorables sur le terrain. Participez à nos tournois de rugby et perfectionnez vos compétences de jeu.</p>
        <p style="text-align: center;"><strong>Int&eacute;grez nos &eacute;quipes de rugby pour des entra&icirc;nements et des comp&eacute;titions stimulantes.</strong></p>
        ...
        <br>
        <h3 style="text-align: center;">Pourquoi choisir le rugby de compétition avec Sportify ?</h3>
        ...
        <br>
        <h3 style="text-align: center;">D&eacute;couvrez notre coach sp&eacute;cialis&eacute;e en Rugby : </h3>
        <br>
