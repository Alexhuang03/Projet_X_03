...
<html lang="fr">
    ...
    <div id="wapper">
        ...
        <section id="Plongeon">
            <h2>Plongeon</h2>
            <p><strong>Rejoignez nos équipes de plongeon et vivez l'excitation des compétitions aquatiques spectaculaires !</strong></p>
            <p>Le plongeon est bien plus qu'un sport, c'est un art qui combine la grâce, la précision et le courage. Chez Sportify, nous offrons à nos membres l'opportunité de participer à des compétitions de plongeon passionnantes et de vivre des moments mémorables dans l'eau. Participez à nos compétitions de plongeon et perfectionnez vos compétences de saut.</p>
            <br>
            <p><strong>D&eacute;couvrez nos sessions de plongeon pour les amateurs de sports aquatiques extr&ecirc;mes.</strong></p>
            ...
            <br>
            <h3>Pourquoi choisir le plongeon de compétition avec Sportify ?</h3>
            <ul>
